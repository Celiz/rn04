...
const supabase = createClient(supabaseUrl, "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhnZWpzaWpqbXJkYW9xY3V5dHZ6Iiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTczMDE0Nzc1NywiZXhwIjoyMDQ1NzIzNzU3fQ.RNQTHKJIEabOBMbS95jITWIervUqTuJuiMqJlePuihQ", {
    auth: {
